...
|------------|------|--------|
| **Print** | Area | Select area interactively (opens shutter GUI) |
| **Shift + Print** | Window | Capture active window (opens shutter GUI) |
| **Alt + Print** | Fullscreen | Capture entire screen (opens shutter GUI) |
| **Ctrl + Print** | Area | Select area and save instantly to ~/Pictures/Screenshots |
| **Ctrl + Shift + Print** | Window | Capture active window and save instantly |
| **Ctrl + Alt + Print** | Fullscreen | Capture screen and save instantly |

**Video Recording (FFmpeg):**

| Keybinding | Mode | Action |
|------------|------|--------|
| **Super + Print** | Area | Select area with slop, start recording with audio |
| **Super + Shift + Print** | Window | Record active window with audio |
| **Super + Alt + Print** | Fullscreen | Record entire screen with audio |
| **Super + Ctrl + Print** | Area | Select area and save recording to ~/Videos/Recordings |
| **Super + Ctrl + Shift + Print** | Window | Record window and save to ~/Videos/Recordings |
| **Super + Ctrl + Alt + Print** | Fullscreen | Record screen and save to ~/Videos/Recordings |
| **Super + Escape** | — | Stop all active recordings |

**Scripts:** All screenshot and video recording functionality is handled by scripts in `~/dev/linux/scripts/`:
- `screenshot-shutter.sh` - Screenshot capture with shutter
- `video-start.sh` - Start FFmpeg video recording
- `video-stop.sh` - Stop active recordings
